(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./parser/htmlScanner", "./parser/htmlParser", "./services/htmlCompletion", "./services/vueCompletion", "./services/htmlHover", "./services/formatters", "./services/htmlLinks", "./services/htmlHighlighting", "./services/htmlSymbolsProvider", "vscode-languageserver-types"], factory);
    }
    ...
    var vueCompletion_1 = require("./services/vueCompletion");
    var htmlHover_1 = require("./services/htmlHover");
    var formatters_1 = require("./services/formatters");
    ...
    function getVls() {
        return {
            ...
            doVueComplete: vueCompletion_1.doVueComplete,
            doHover: htmlHover_1.doHover,
            htmlFormat: formatters_1.htmlFormat,
            cssFormat: formatters_1.cssFormat,
