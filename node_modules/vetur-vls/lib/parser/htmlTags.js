...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../utils/strings", "../utils/arrays", "vscode-nls", "./vueApi"], factory);
    }
    ...
    var vueApi_1 = require("./vueApi");
    function getVueTagProvider() {
        return {
            getId: function () { return 'vue'; },
            isApplicable: function (languageId) { return languageId === 'vue-html'; },
            collectTags: function (collector) {
                // no extra tags
            },
            collectAttributes: function (tag, collector) {
                vueApi_1.vueDirectives.forEach(function (a) {
